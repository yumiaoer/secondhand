...
class AdministratorsControllerTest < ActionController::TestCase
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post :create, administrator: { empno: @administrator.empno, password: @administrator.password, realname: @administrator.realname, username: @administrator.username }
    end
  ...
  test "should update administrator" do
    patch :update, id: @administrator, administrator: { empno: @administrator.empno, password: @administrator.password, realname: @administrator.realname, username: @administrator.username }
    assert_redirected_to administrator_path(assigns(:administrator))
  end
